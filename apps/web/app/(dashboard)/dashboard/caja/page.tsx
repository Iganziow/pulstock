  ...
  return (
    <div style={{ maxWidth: 820, margin: "0 auto", padding: mob ? "16px 12px" : "24px 16px", fontFamily: "'DM Sans', system-ui, sans-serif" }}>
      ...
      <div style={{ marginBottom: 24, display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 12, flexWrap: "wrap" }}>
        ...
        {/* Daniel 01/05/26: el botón "+ Movimiento" se movió a
            /dashboard/caja/movimientos para evitar duplicación. Acá
            queda el botón "+ Agregar movimiento" del bloque CajaLiveSession. */}
